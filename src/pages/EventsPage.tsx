    ...
    <div className="min-h-screen bg-[#FAFDF4] px-12 py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#BFD76F] to-[#6F8C1F] mx-auto mb-4"></div>
          <p className="text-xl text-[#475C1D] max-w-2xl mx-auto">Navega entre nuestros eventos y encuentra el perfecto para ti</p>
        </div>

        {/* Event Card */}
        <div className="max-w-6xl mx-auto">
          <div className="overflow-hidden shadow-xl border border-[#DDE9BB] bg-white/90 relative rounded-xl transition-all">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                {/* Title */}
                <h3 className="text-3xl font-bold text-[#2E321B] mb-6 leading-tight">{events[currentEvent].title}</h3>

                {/* Description */}
                <p className="text-[#475C1D] text-base leading-relaxed mb-8">
