  ...
  return (
    <section className="min-h-screen bg-neutral-100 py-20 px-6">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Forma parte de la Cámara de Ganaderos</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16">
        {/* ASOCIADOS CARD (ahora usa colores VERDES) */}
        <div className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 rounded-2xl">
          ...
          <div className="p-8 relative z-10">
            ...
            {/* Botón */}
            <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 flex items-center justify-center">
              Formulario
        ...
        {/* VOLUNTARIOS CARD (ahora usa colores DORADOS) */}
        <div className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 rounded-2xl">
