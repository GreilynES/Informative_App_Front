...
export default function FooterPage() {
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        nter md:items-start space-y-3">
          <img
            ...
            className="w-16 mb-2"
          />
          <p className="text-sm font-medium text-center md:text-left text-gray-300 leading-snug">
        ...
        <div className="space-y-3">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm text-gray-300 hover:text-green-500 transition-colors"
          >
      ...
      {/* COPYRIGHT */}
      <div className="border-t border-neutral-800 text-center py-5 text-xs text-gray-500">
