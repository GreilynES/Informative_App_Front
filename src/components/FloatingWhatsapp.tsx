  ...
  return (
    <div >
          ...
          >
            ...
            <span className="hidden sm:block font-medium whitespace-nowrap">¿Cómo puedo ayudarte?</span>

            {/* Mobile version - just icon with tooltip */}
            <span className="sm:hidden sr-only">Contactar por WhatsApp</span>
          </a>
        </div>
  )
}
