...
export function RequirementsSection({
  ...
  return (
    <div className="bg-white/80 rounded-xl p-8 shadow-md border border-[#DCD6C9] max-w-6xl mx-auto mb-16">
      <h2 className="text-3xl font-bold text-[#708C3E] text-center mb-8">
        Requisitos
      </h2>
        ...
        <div className="text-center mt-10">
          <div className="inline-flex gap-20">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#6F8C3F] to-[#475C1D] hover:from-[#5d741c] hover:to-[#384c17] text-white rounded-md font-medium px-6 py-3 text-lg transition"
            >
          ...
          <div className="bg-white p-8 rounded-xl shadow-2xl max-w-lg mx-4 transition-all duration-250">
            ...
            <div className="space-y-4 mb-6">
              <p className="text-gray-700 text-lg">
                Antes de continuar, asegúrese de tener disponibles los
                ...
                {tipoSeleccionado === "INDIVIDUAL" ? (
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-2">
                      <svg
                        className="w-5 h-5 text-[#708C3E] mt-0.5 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Documento legal de la organización</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Documento adicional que se considere relevante</strong>
                      </span>
                    </li>
                  </ul>
                )}
